...
#TODO create lvl not only from image beacuse is bad to scale
...
def update():
    ...
    player.move(keys)
    #TODO move enemy movement to class update and invoke update as lists or lamda functions not after
    enemy.move(250,500)
    enemy2.move(250,500)
    enemy3.move(250,500)
    enemy4.move(250,500)
...
#TODO check if it is possible to not always draw everything because solws down the game
def draw():
